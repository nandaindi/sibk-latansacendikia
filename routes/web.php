...
use App\Http\Controllers\BK\ArtikelController;
...
Route::middleware(['auth', 'role:bk'])->prefix('bk')->name('bk.')->group(function () {
    ...
    Route::get('/panggil-siswa', [PemanggilanController::class, 'index'])->name('panggil-siswa.index');
    Route::post('/panggil-siswa/store', [PemanggilanController::class, 'store'])->name('panggil-siswa.store');
    Route::get('/panggil-siswa/detail/{id}', [PemanggilanController::class, 'detail'])->name('panggil-siswa.detail');
    Route::post('/panggil-siswa/update/{id}', [PemanggilanController::class, 'update'])->name('panggil-siswa.update');
    Route::get('/riwayat-panggilan', [PemanggilanController::class, 'riwayat'])->name('riwayat-panggilan');
    ...
    Route::get('/artikel/{id}/preview', [ArtikelController::class, 'preview'])->name('artikel.preview');
