...
<!-- Mobile: Full-page list mode shown via FAB -->
@endsection
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        function openDropdown() {
            ...
            // Give browser time to remove hidden before transition
            setTimeout(() => {
