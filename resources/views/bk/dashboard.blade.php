    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-[24px] border border-[#edf2f1] shadow-[0_4px_12px_rgba(0,0,0,0.02)] p-6">
            ...
            <div class="flex flex-col gap-3">
                ...
                <div class="p-4 rounded-xl border border-[#eee] bg-[#fcfdfd] hover:border-[#f59e0b] transition-colors">
                    <div class="flex items-center justify-between gap-3">
                        <div class="flex items-center gap-3 flex-1 min-w-0">
                            ...
                            <div class="min-w-0">
                                <div class="font-bold text-[#1a1a1a] text-[0.95rem] truncate">{{ $pending->user->name }}</div>
                                <div class="text-[0.78rem] text-[#777]">{{ $pending->jenis_layanan ?? ucfirst($pending->jenis) }}</div>
