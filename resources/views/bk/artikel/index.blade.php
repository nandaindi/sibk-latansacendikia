                    ...
                    <tr class="hover:bg-[#fcfdfd] transition-colors">
                        ...
                        <td class="p-4 text-right">
                            <div class="flex items-center justify-end gap-2">
                                ...
                                <form action="{{ route('bk.artikel.destroy', $artikel->id) }}" method="POST" class="inline" onsubmit="return confirm('Hapus artikel ini?')">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="p-2 text-[#ef4444] hover:bg-[#fef2f2] rounded-lg transition-colors border-none bg-transparent cursor-pointer" title="Hapus">
