...
<div class="w-full max-w-2xl mx-auto px-5 md:px-0 py-4 mb-24 md:mb-8">
    ...
    <form method="POST" action="{{ route('bk.profile.update') }}" enctype="multipart/form-data" class="flex flex-col gap-4">
        ...
        {{-- NIP (Read Only) --}}
        <div class="border-[2px] border-[#eee] rounded-2xl px-5 py-3.5 bg-[#f9f9f9] transition-all">
            <label class="flex items-center gap-1.5 text-[0.8rem] text-[#aaa] font-bold mb-1 uppercase tracking-wider"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg> NIP / NUPTK</label>
        ...
        {{-- Jabatan (Read Only) --}}
        <div class="border-[2px] border-[#eee] rounded-2xl px-5 py-3.5 bg-[#f9f9f9] transition-all">
            <label class="flex items-center gap-1.5 text-[0.8rem] text-[#aaa] font-bold mb-1 uppercase tracking-wider"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg> Jabatan</label>
        ...
        <div class="border-[2px] border-[#eee] rounded-2xl px-5 py-3.5 bg-[#f9f9f9] transition-all">
            <label class="flex items-center gap-1.5 text-[0.8rem] text-[#aaa] font-bold mb-1 uppercase tracking-wider"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg> Nomor Telepon</label>
