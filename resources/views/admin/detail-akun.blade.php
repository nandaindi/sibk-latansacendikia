...
<div class="w-full">
    ...
    <div class="bg-white border-[2px] border-[#1a9488] rounded-2xl p-6 md:p-8 flex items-center gap-6 shadow-sm">
        ...
        <div class="flex flex-col gap-1.5 md:gap-2">
            ...
            <p class="text-[0.95rem] md:text-[1.1rem] font-bold text-[#1a1a1a]">Role &nbsp;&nbsp;: <span class="capitalize">{{ $user->getRoleNames()->first() }}</span></p>
            ...
            <div class="flex gap-3 mt-4">
                ...
                <button onclick="showDeleteModal({{ $user->id }})" class="px-6 py-2 bg-[#ef4444] text-white rounded-full text-[0.85rem] font-bold hover:brightness-105 transition-all border-none cursor-pointer shadow-md">Hapus Akun</button>
            </div>
        </div>
    </div>
