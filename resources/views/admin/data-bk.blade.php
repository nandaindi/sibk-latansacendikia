...
<div class="flex items-start justify-between mb-5 gap-4 flex-wrap">
    ...
    <div class="flex flex-col items-end gap-1">
        <span class="text-[0.78rem] text-[#888] mr-1">data guru bk</span>
...
<div id="bkList" class="flex flex-col gap-3 w-full">
    @forelse($bk as $item)
    <div class="bk-item bg-white border-[2px] border-[#1a9488] rounded-2xl px-5 py-3.5 flex items-center gap-4 shadow-sm hover:shadow-md transition-shadow">
        <span class="w-[40px] shrink-0 text-center text-[0.85rem] font-bold text-[#1a9488]">{{ $loop->iteration + ($bk->currentPage() - 1) * $bk->perPage() }}</span>
