...
<div class="flex items-start justify-between mb-5 gap-4 flex-wrap">
    <div>
        ...
        <div class="mt-3">
            <a href="{{ route('admin.kelola-laporan.tambah') }}" class="inline-flex items-center gap-1.5 px-5 py-2 bg-[#1a9488] text-white rounded-full text-[0.9rem] font-bold hover:brightness-105 transition-all shadow-[0_4px_12px_rgba(26,148,136,0.3)] no-underline">
    ...
    <div class="flex flex-col items-end gap-1">
        <span class="text-[0.78rem] text-[#888] mr-9">kelola laporan</span>
